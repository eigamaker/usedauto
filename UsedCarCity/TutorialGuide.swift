    ...
    static let all: [GuideLesson] = [
        ...
        GuideLesson(
            ...
            speech: [
                ...
                "仕入れ先は4つ。業者間の卸、オークション、ネット仕入れ、そしてお客様からの買取。最初は卸で3台そろえるのが安全です。",
        ...
        GuideLesson(
            ...
            speech: [
                ...
                "店員の担当は「販売」「仕入」「調査」「整備」の4つ。担当を割り当てた店員は、オーナーとは別枠で週7件を自動で処理します。",
        ...
        GuideLesson(
            ...
            title: "業務を自動運用にする",
            speech: [
                "担当を決めたら、自動運用をONにします。販売・集客・整備・買取仕入をそれぞれ切り替えられます。",
                "仕入担当は登録した「仕入れ指示」に沿って4経路を回ります。指示がなければ動きません。",
                "店長を採用すると、配置と方針の調整まで任せられます。オーナーは大きな判断に集中してください。"
            ],
            objective: "「店員」タブで、いずれかの自動運用をONにしてください。",
            tip: "自動運用は方針（販売量重視・粗利重視など）とセットで決めます。方針は毎週見直せます。",
            expression: .smile,
